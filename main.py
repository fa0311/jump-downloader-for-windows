...
class jumpplus_downloader_for_win:
    def __init__(self):
        window = tkinter.Tk()
        window.title("jump-downloader-for-windows")
    ...
    def input_window(self, window):
        ...
        enter_button = tkinter.Button(window, text="決定", width=50)
    ...
    def click(self, event):
        ...
        while url:
            ...
            jpd.auto_list_download(
                url=url, sleeptime=0, pdfConversion=self.pdf_flag.get()
            )
...
if __name__ == "__main__":
    jumpplus_downloader_for_win().mainloop()
